// Vite's eager raw glob keeps the source guard browser-build compatible without
// Node fs types, and -- unlike importing "./App.tsx?raw" -- it keeps covering the
// UI once App.tsx is split into components: a forbidden import moved to a sibling
